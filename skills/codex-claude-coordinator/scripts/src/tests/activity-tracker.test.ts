...
import { ToolActivityTracker, type TrackedToolActivity } from "../activity-tracker.js";
import type { NormalizedEvent } from "../monitor.js";

const hookEvent = (kind: string, toolUseId: string, agentId: string): NormalizedEvent => ({
...
const activity = (toolUseId: string, agentId: string): TrackedToolActivity => ({
  kind: "tool",
  label: toolUseId,
